...
export const project = [
  ...
  },
  {
    ...
    desc: "Avian Medical is a website requested by the Operational division, HRGA department. Avian Medical was created to digitize their tasks such as health assessments, medical check-ups, management of health-related activities, and medicine stock management. With this website, all data is recorded digitally, making it easier to search for and use",
    github: "",
    github2: "",
  ...
  },
  {
    ...
    tech: ["laravel", "bootstrap", "mysql"],
    desc: "Ticket QC is a website requested by the Operational division, Quality Control & Processing (QCP) department. This website aims to facilitate the teams within the division in managing their tasks",
    github: "",
    github2: "",
