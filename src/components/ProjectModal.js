...
const ProjectModal = ({ closeModal, selectedID = 0, type = 0 }) => {
  ...
  if (projectIndex !== 0 || selectedID !== 0) {
    ...
    if (data.github === "" && data.github2 === "") {
      githubButton = <p className="text-center text-sunset font-medium">*Source Code Not Available*</p>;
    } else {
      if (data.github2 === "") {
        githubButton = (
          <a href={data.github} className="self-center lg:text-xs xl:text-base  block  my-4 bg-[#2b3137] hover:bg-[#24292e] hover:drop-shadow-xl text-center text-[#fafbfc] py-2 w-2/4 rounded-full font-medium">
      ...
      {projectIndex === 0 && selectedID === 0 ? (
        <div className="size-full flex flex-col">
          <div className="basis-1/12 flex flex-row w-full h-full justify-between items-center bg-onyx rounded-t-2xl lg:p-2 xl:p-4">
            <p className="font-display text-sunset font-bold lg:text-lg xl:text-xl">All Project</p>
        ...
        <div className="size-full flex flex-col">
          <div className="basis-1/12 flex flex-row w-full h-full justify-between items-center bg-onyx rounded-t-2xl lg:p-2 xl:p-4">
            <p className="font-display text-sunset font-bold lg:text-lg xl:text-xll">Project Detail</p>
