...
const Contact = ({ reference, openLoading, closeLoading }) => {
  return (
    <section ref={reference} id="contact" className="relative bg-jet min-h-screen w-full px-8 lg:px-9 py-4 lg:py-14 snap-center flex flex-col justify-center">
      ...
      <div className="w-full h-[80%] flex flex-col lg:flex-row gap-4 lg:gap-0 lg:mb-12 lg:justify-between">
        <div className="w-full lg:w-[30%] h-[95%] lg:h-full flex flex-col gap-4 p-10 lg:p-0">
          <div onClick={() => (window.location.href = "mailto:aldocahyadi28@gmail.com")} className="hover:cursor-pointer h-full w-full  bg-platinum rounded-2xl flex flex-col items-center justify-evenly">
            <FontAwesomeIcon icon={faEnvelope} className="text-eerie-black size-10 lg:size-8" />
            <p className="hidden lg:block font-display text-[6px] lg:text-sm text-eerie-black">aldocahyadi28@gmail.com</p>
          </div>
          <div onClick={() => (window.location.href = "https://wa.me/6285174241330")} className="hover:cursor-pointer h-full w-full  bg-platinum rounded-2xl flex flex-col items-center justify-evenly">
            <FontAwesomeIcon icon={faWhatsapp} className="text-eerie-black size-10 lg:size-8" />
          ...
          <div
            ...
            className="hover:cursor-pointer h-full w-full  bg-platinum rounded-2xl flex flex-col items-center justify-evenly"
          >
            <FontAwesomeIcon icon={faLocationDot} className="text-eerie-black size-10 lg:size-8" />
            <p className="hidden lg:block font-display text-[6px] lg:text-sm text-eerie-black">Surabaya, Indonesia</p>
          </div>
        </div>
        <ContactForm openLoading={openLoading} closeLoading={closeLoading} />
      </div>
