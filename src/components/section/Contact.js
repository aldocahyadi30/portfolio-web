...
const Contact = () => {
  function copyNumber() {
    navigator.clipboard.writeText("+6285174241330");
  ...
  return (
    <section id="contact" className="relative bg-jet lg:bg-raisin-black h-screen lg:min-h-screen w-full px-8 lg:px-20 xl:px-24 p-16 lg:p-0 lg:py-24 xl:py-24 flex flex-col snap-center">
      ...
      <div className="w-full h-full grid p-8 lg:p-0 gap-4 lg:gap-16 grid-cols-1 lg:grid-cols-2">
        ...
        <div onClick={() => window.location.href = 'https://www.google.com/maps/place/Surabaya,+East+Java/@-7.2755897,112.5478708,11z/data=!3m1!4b1!4m6!3m5!1s0x2dd7fbf8381ac47f:0x3027a76e352be40!8m2!3d-7.2574719!4d112.7520883!16zL20vMDFmNHhk?entry=ttu'} className="hover:cursor-pointer w-full h-full border border-hunyadi-yellow rounded-2xl flex flex-col items-center justify-evenly">
